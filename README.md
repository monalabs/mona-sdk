...
- MONA_SDK_APP_SERVER_URL - When provided, all messages to mona's rest-api will use this address instead of the default 
  one.
- MONA_SDK_REST_API_URL - When provided, all configuration related calls to mona's servers will use this address instead
  of the default one.
