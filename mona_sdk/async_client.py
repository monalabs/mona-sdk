...
class AsyncClientSignatures(Client):
    def is_active_async(self):
        pass

    def export_async(self, message: MonaSingleMessage, filter_none_fields=None):
        pass
    ...
    def upload_config_async(self, config, commit_message, author=None):
        pass
    ...
    def get_config_async(self):
        pass

    def get_suggested_config_async(self):
        pass

    def get_config_history_async(self, number_of_revisions=UNPROVIDED_VALUE):
        pass

    def get_sampling_factors_async(self):
        pass

    def create_sampling_factor_async(
        self, config_name, sampling_factor, context_class=None
    ):
        pass
    ...
    def get_suggested_config_from_user_input_async(self, events):
        pass
...
class AsyncClient(Client, metaclass=AsyncMeta):
    ...
    def is_active_async(self, event_loop=None, executor=None):
        pass
